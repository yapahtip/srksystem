    ...
    <div class="container-fluid">
        <div class="row page-titles">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ route('user/table') }}">List User</a></li>
            </ol>
        </div>
        <div class="row">
            <div class="col-12">
                            ...
                            <table id="example2" class="display" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        @endif
                                        <td><span class="group_name">{{$items->group_name}}</span></td>
                ...
                <form action="{{ route('user/update') }}" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <input type="text" class="form-control" id="e_group_name" name="group_name" readonly>
                        </div>
                    </div>
                    <div class="row">
                        <div class="mb-3 col-md-6">
...
@section('script')
    ...
    <script>
        $(document).on('click','.edit_user',function()
        {
            ...
            $('#e_group_name').val(_this.find('.group_name').text());
